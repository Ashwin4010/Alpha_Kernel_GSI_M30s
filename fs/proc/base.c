...
#ifdef CONFIG_PROC_INDIABLOCKER
	if (!err) {
		if (!strcmp(task_comm, "com.ss.android.ugc.aweme") ||
			!strcmp(task_comm, "com.ss.android.ugc.boomlite") ||
			!strcmp(task_comm, "com.ss.android.ugc.tiktok.livewallpaper") ||
			!strcmp(task_comm, "com.zhiliao.musically.livewallpaper") ||
			!strcmp(task_comm, "com.zhiliaoapp.musically") ||
			!strcmp(task_comm, "com.zhiliaoapp.musically.go")||
